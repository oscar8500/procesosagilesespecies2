...
urlpatterns = [
    ...
    url(r'^especies/logout/$', views.logout_request, name='logout'),
    url(r'^especies/isLogged/$', views.islogged, name='isLogged'),
    url(r'^especies/editUser/$', views.editar_usuario, name='editUser'),
