...
class City(models.Model):
    ...
    country = models.ForeignKey(Country, blank=False, null=True, on_delete=models.CASCADE,
                                verbose_name="Seleccion de Pais")
...
class Comment(models.Model):
    ...
    def __unicode__(self):
        return 'Comment No.' + str(self.id) + ' by ' + self.email
